...
<div class="card">
    ...
    <div class="card-body">
        <div class="col-md-6 mb-3 d-flex flex-row">
            ...
            &nbsp;
            <button id="btnSearch" name="btnSearch" type="button" class="btn btn-sm btn-info" data-toggle="Cari"
                data-placement="top" title="Cari"><i class="fas fa-search"></i></button>&nbsp;
            <button id="reset" name="reset" type="button" class="btn btn-sm btn-warning reset" data-toggle="Reset"
                data-placement="top" title="Reset"><i class="fas fa-undo"></i></button>
