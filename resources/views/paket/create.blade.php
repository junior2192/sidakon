    ...
    <div class="card-body">
        <form action="{{ route('paket.create') }}" method="post">
            ...
            <div class="form-group row">
                ...
                {{-- <input type="date" class="form-control" id="tahun_anggaran" value="{{ old('tahun_anggaran') }}"
                    name="tahun_anggaran" required> --}}
                <select name="tahun_anggaran" id="tahun_anggaran" class="form-control select2" required>
                    <option value="" selected disabled>Pilih Tahun</option>
                    @for ($i = 1980; $i <= date('Y'); $i++) <option value="{{ $i }}"> {{ $i }} </option>
                        @endfor
                </select>
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control" id="no_kontrak" value="{{ old('no_kontrak') }}"
                    name="no_kontrak">
            </div>

            <div class="form-group row">
                <label for="tgl_kontrak">Tanggal Kontrak</label>
                <input type="date" class="form-control" id="tgl_kontrak" value="{{ old('tgl_kontrak') }}"
                    name="tgl_kontrak">
            </div>

            <div class="form-group row">
                <label for="penyedia_jasa">Penyedia Jasa</label>
                <input type="text" class="form-control" id="penyedia_jasa" value="{{ old('penyedia_jasa') }}"
                    name="penyedia_jasa">
            </div>
