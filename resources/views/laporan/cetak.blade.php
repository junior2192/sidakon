...
<body>
    <div class="container-fluid row">
        <table class="table borderless">
            <tr>
                <td style="width: 60px"><img src="{{ public_path('img/logo.png') }}" class="img-fluid" alt="logo"
                        style="width: 62px; height: 60px"></td>
                <td></td>
                <td class="text-center">
                    <h4 class="">DATA REKAP PEKERJAAN</h4>
                    <h4>PPK PERENCANAAN & PROGRAM</h4>
                </td>
                <td></td>
            </tr>
        </table>
